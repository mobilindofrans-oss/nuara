...
function buildTicketHTML(t) {
    ...
    if (alamatAgen) headerInfo += `<p class="text-center" style="font-weight:700;font-size:13px;margin:0.5mm 0;">${up(alamatAgen)}</p>`;
    hpAgenList.forEach(function (h) {
        if (h) headerInfo += `<p class="text-center" style="font-weight:700;font-size:13px;margin:0.5mm 0;">📞 ${esc(h)}</p>`;
    });
    ...
    const rules =
        `<ol style="margin:0;padding-left:12px;font-weight:700;font-size:12px;line-height:1.3;">` +
    ...
    return `
        <div class="bagian-tiket">
            ...
            <p class="text-center" style="font-weight:700;font-size:13px;">— ${up(namaAgen)} —</p>
        </div>
